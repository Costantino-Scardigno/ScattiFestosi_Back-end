...
import com.ScattiFestosi.payload.request.EventRequest;
import com.ScattiFestosi.payload.response.EventResponse;
import com.ScattiFestosi.payload.response.MessageResponse;
import com.ScattiFestosi.payload.response.ShareLinkResponse;
...
public class EventController {
    ...
    public ResponseEntity<?> getSharedEvent(@PathVariable String shareCode,
        ...
        // Se l'utente è autenticato, aggiungiamo automaticamente l'evento alla sua lista di codivisi
